...
### Changed
- **프론트(프레즌스 UI·라이트/크림)**: 오프라인 점을 어두운 슬레이트 단색 대신 **밝은 회색 채우기**·옅은 링으로 바꾸고, 온라인은 **더 선명한 초록**·자리비움은 **노란색**(`#eab308` / 크림 `#ca8a04`) 링으로 구분. 아바타 모서리·조직도 점에도 동일 톤 적용. `frontend/styles.css`.
