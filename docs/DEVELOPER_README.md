...
- **AI 프로액티브·제안함 (7-3 MVP)**: `GET|PUT /api/channels/{channelId}/ai-assistant/preference`, `GET|PUT /api/me/ai-assistant/preferences`, `GET /api/me/ai-suggestions`, `POST /api/me/ai-suggestions/{id}/dismiss|acknowledge`. 도메인 `com.ech.backend.domain.aiassistant`. 이관 SQL `docs/sql/migrate_ai_phase_7_3.sql`.
